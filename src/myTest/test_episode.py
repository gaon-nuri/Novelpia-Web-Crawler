...
from src.func.common import print_under_new_line
from src.func.episode import Ep, extract_ep_info, extract_ep_tags, get_ep_list, get_ep_view_counts, has_prologue
...
class ChkMetaClass(TestCase):
    def test_inherit_user_meta_class(self):
        ...
        from src.func.common import UserMeta
        from src.func.episode import Ep
    ...
    def test_extract_ep_title(self):
        ...
        for test_params in test_set:
            ...
            with self.subTest(code=code, sort=sort, ep_no=ep_no, title_a=title_a):
                ...
                ep_tags: Generator = extract_ep_tags(html, frozenset({ep_no}))
...
class GetEpViewCount(TestCase):
    def test_get_ep_view_cnt(self):
        ...
        got_view_counts: Generator = get_ep_view_counts(novel_code, ep_codes, 1)
        assert got_view_counts is not None, "조회수를 받지 못했어요."

        got_view_count = next(got_view_counts)
    ...
    def test_get_ep_view_cnt_list(self):
        ...
        got_view_counts: Generator = get_ep_view_counts(novel_code, ep_codes, ep_count)
